    ...
    render() {
        const columns = [
            ...
            },
            {
                ...
                render: (_, item) => (
                    <Space size="middle" >
                        <button disabled={!dataCheckPermis['post.view_category']} onClick={() => this.openModal('detail', true, item.id)}><AiFillEye /></button>
        ...
        const { dataCheckPermis, listItemSelected, dataFilter, dropButtonType,
            modalCreate, modalEdit, modalDetail } = this.state;
        ...
        return (
            <>
                ...
                {modalDetail && dataCheckPermis['post.view_category'] &&
...
const mapStateToProps = state => {
    return {
        ...
        dataMeta: state.categoryPost.dataMeta,
