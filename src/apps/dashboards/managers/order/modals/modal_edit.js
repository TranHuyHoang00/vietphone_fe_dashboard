...
import { edit_customer } from '../../../../../services/customer_service';
class modal_edit extends Component {
    ...
    async componentDidUpdate(prevProps) {
        if (prevProps.data_customer !== this.props.data_customer) {
            this.setState({ data_customer: this.props.data_customer });
        }
    }
