...
class index extends Component {
    ...
    handle_funtion_menu = async () => {
        ...
        if (this.state.type_menu === 2) { await this.props.edit_list_post(data_selected, { is_active: false }); }
        if (this.state.type_menu === 3) { await this.props.edit_list_post(data_selected, { is_active: true }); }
