...
class index extends Component {
    ...
    open_modal = async (name, value, id) => {
        ...
        if (name === 'detail') {
            if (id === undefined) {
                this.setState({ modal_detail: value, data_category_post: {} });
            } else {
    ...
    handle_funtion_menu = async () => {
        ...
        if (this.state.type_menu === 2) { await this.props.edit_list_category_post(data_selected, { is_active: false }); }
        if (this.state.type_menu === 3) { await this.props.edit_list_category_post(data_selected, { is_active: true }); }
