...
class select_group_attribute extends Component {
    ...
    onchange_select = async (value) => {
        await this.get_group_attribute(value);
        this.props.handle_get_data(this.state.data_group_attribute.attributes, 'attribute');
    }
    render() {
                ...
                <Spin size='large' spinning={this.state.is_loading}>
                    <div className='space-y-[3px]'>
                        ...
                        <Select style={{ width: '100%' }} placement='topRight'
                            ...
                            value={this.state.data_group_attribute.id}
                            dropdownRender={(menu) => (
                                <div className='p-[5px]'>
                                    {menu}
                                    <Divider />
